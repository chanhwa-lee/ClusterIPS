...
#' @examples 
#' estimand.mis(N = 10, deltas = c(0.5,1,2), r = 100)

estimand.mis <- function(N, deltas, r){
...
#' delta values
#' @examples 
#' estimator.mis(dat, X.trt, X.out, deltas = seq(0.5,2,0.1), K = 2, r = 100)

estimator.mis <- function(dat, X.trt, X.out, deltas, K, r){
